...
class AuthorWiseListView extends StatefulWidget {
  final String author;

  AuthorWiseListView({this.author});

  @override
  _AuthorWiseListViewState createState() => _AuthorWiseListViewState();
}

class _AuthorWiseListViewState extends State<AuthorWiseListView> {
  //props
