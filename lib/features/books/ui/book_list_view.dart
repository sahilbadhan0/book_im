...
class BooksListingView extends StatefulWidget {
  @override
  _BooksListingViewState createState() => _BooksListingViewState();
}

class _BooksListingViewState extends State<BooksListingView> {
  //props
