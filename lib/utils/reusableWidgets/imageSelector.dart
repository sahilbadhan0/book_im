...
class ImageSelector extends StatefulWidget {
  ...
  ImageSelector({this.height:60,this.width:60,this.onSelect, this.hideEditButton:true });
  @override
            ...
            Container(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: AppColors.primaryColor//todo
                ),
                child: _image==null? Icon(Icons.camera_enhance):ClipOval(
            ...
            bottom: 0,
              child: Offstage(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(color: AppColors.primaryColor,shape: BoxShape.circle,//todo
