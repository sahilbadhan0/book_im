...
class FolioActivity : AppCompatActivity(), FolioActivityCallback, MediaControllerCallback,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        UiUtil.setColorIntToDrawable(
                ...
                (findViewById<View>(R.id.imgBack) as ImageView).drawable
        )
        UiUtil.setColorIntToDrawable(
                mConfig!!.getCurrentThemeColor(),
                (findViewById<View>(R.id.imgDrawer) as ImageView).drawable
        )


        imgBack?.setOnClickListener { onBackPressed() }
        imgDrawer?.setOnClickListener { startContentHighlightActivity() }
    }
...
//        else
    ...
    private fun initBook() {
        ...
        txtBookTitle?.text = bookFileName
        ...
        txtBookTitle?.text = pubBox!!.publication.metadata.title
